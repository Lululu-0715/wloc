...
1. 订阅模块并启用 MITM
2. 打开在线选点页面 https://wloc-1993.575613136.workers.dev/ （建议添加到主屏幕）
3. 地图选位置 / 搜索地名 / 粘贴地图链接
4. 点击「储存到设备」
...
<details>
<summary><b>选点页面 / 自部署 Worker</b></summary>

选点页面地址：

- **在线选点页面**: https://wloc-1993.575613136.workers.dev/ （建议添加到主屏幕）

想换成自己的实例，按下面步骤部署，然后把模块里的 `openUrl` / `desc` 地址一并替换即可：
